    ...
    <div className=''>
      ...
      <main>
        <div className='w-10/12 m-auto'>
          <h1 className=' text-6xl  mt-12 font-bold'>About Us.</h1>
          <span className='text-1xl font-bold'>会社概要</span>
        </div>
        <div className='w-10/12 m-auto'>
          <h1 className=' text-3xl  mt-48 font-bold'>Social Vision.</h1>
          ...
          <div className='mt-20'>
            ...
            <div>
              <table className='text-sm w-full lg:w-10/12 m-auto mt-10'>
                <tr className='py-5 text-xl'>
                  <th className='border-b-2 border-black py-4'>会社名</th>
                  <td className='text-center border-b border-red'>Si-cle Inc.（株式会社サイクル）</td>
                </tr>
