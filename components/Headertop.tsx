...
const Headertop: React.FC = () => {
  return (
    <Popover className="sticky top-0 z-50 bg-opacity-0">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center  border-gray-100 py-10 md:justify-start md:space-x-10">
          ...
          <Popover.Group as="nav" className="hidden md:flex space-x-10">
            <Link href={"/"}>
              <a className="text-base font-medium  hover:text-gray-900">Top</a>
            </Link>
            <Link href={"/about"}>
            ...
            <Link href={"/news"}>
              <a className="text-base font-medium hover:text-gray-900 hidden">
                News
              </a>
            </Link>
            <Link href={"/mail"}>
